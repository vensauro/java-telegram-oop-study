 ...
 * JogadorNormal
 */
public class JogadorNormal extends Usuario implements Jogador {

    private String charactName = "Civil";

    public JogadorNormal(long id, String nome) {
        super(id, nome);
    }

    public JogadorNormal(long id, String nome, boolean morto) {
        super(id, nome, morto);
    }
    ...
    public void acao(Jogo jogo, Update update, MessageCallback callback) {
        callback.apply(Utils.sendMessage(this.getId(), EmojiParser.parseToUnicode("Você não pode fazer nada :fearful:")));
    }
